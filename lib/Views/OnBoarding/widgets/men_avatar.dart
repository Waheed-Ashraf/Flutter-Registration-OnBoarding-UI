...
class MenAvatars extends StatefulWidget {
  const MenAvatars({super.key});

  @override
  State<MenAvatars> createState() => _MenAvatarsState();
}

class _MenAvatarsState extends State<MenAvatars> {
  String selectedAvatar = menAvatar[0];
  int currentIndex = 0;
  @override
              ...
              child: GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return GestureDetector(
                        onTap: () {
                          setState(() {
                            selectedAvatar = menAvatar[index];
                            currentIndex = index;
                          });
                        },
                        child: CustomCircleAvatar(
                          avatarImage: menAvatar[index],
